...
export const teamMembers: TeamMember[] = [
  {
    ...
    stack: ["React", "React Native", "TypeScript", "JavaScript","Node.js", "Next.js"],
  ...
  },
  {
    ...
    stack: ["Python", "FastAPI", "PostgreSQL", "Docker", "Redis", "RabbitMQ","AWS","GCP","Azure"],
    github: "https://github.com",
    linkedin: "https://linkedin.com",
    initials: "MH",
  ...
  },
  {
    ...
    stack: ["Playwright", "Selenium", "Python", "CI/CD", "Robot Framework", "Pytest"],
    github: "https://github.com",
    linkedin: "https://linkedin.com",
    initials: "DK",
